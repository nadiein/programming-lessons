import { findClosestDistance, findClosestPair } from './main';
...
test('Get float number that represent distance between coordinates from 9, 6, 2, 8 to be equal 7.3', () => {
...
test('Get float number that represent distance between coordinates from 6, 3, 7, 4 to be equal 1.4', () => {
...
test('Get [ [2, 2], [2, 8], [5, 5], [6, 3], [6, 7], [7, 4], [7, 9] ] and return array of closest points [6, 3], [7, 4]', () => {
    expect(findClosestPair(test_array_1)).toEqual([[6, 3], [7, 4]])
});

test('Get [ [2, 2], [2, 8], [5, 5], [5, 5], [6, 3], [6, 7], [7, 4], [7, 9] ] and return array of closest points [5, 5], [5, 5]', () => {
    expect(findClosestPair(test_array_2)).toEqual([[5, 5], [5, 5]])
})
